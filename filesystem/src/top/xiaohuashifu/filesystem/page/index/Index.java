...
public class Index implements Initializable {
    ...
    private void onClickGridPane(MouseEvent mouseEvent) {
        ...
        if (mouseEvent.getButton().name().equals("SECONDARY")
            ...
            ContextMenu contextMenu = new ContextMenu(createFile, createDirectory);
    ...
    private void openFile(String path, double x, double y) {
        top.xiaohuashifu.filesystem.page.file.File file = new top.xiaohuashifu.filesystem.page.file.File(fileManager, path);
        try {
